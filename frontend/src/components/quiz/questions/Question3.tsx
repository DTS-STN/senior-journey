...
export const Question3 = ({ values, setFieldValue }: QuestionProps) => {
  ...
  return (
    <div>
      <h5 className="font-display text-2xl font-light">{t('questions.question-3.title')}</h5>
      <p className="mt-5 font-display text-sm font-light">{t('questions.question-3.subtitle')}</p>
      <ToggleButtonGroup
      ...
      >
        <ToggleButton
          ...
          aria-label={t('questions.question-3.option-1')}
          className="my-4 font-display text-base font-bold normal-case"
          selected={values['financialPreparedness'] === 'very-unprepared'}
        >
          {t('questions.question-3.option-1')}
        </ToggleButton>
        <ToggleButton
          value="unprepared"
          aria-label={t('questions.question-3.option-2')}
          className="my-4 font-display text-base font-bold normal-case"
          selected={values['financialPreparedness'] === 'unprepared'}
        >
          {t('questions.question-3.option-2')}
        </ToggleButton>
        <ToggleButton
          value="unsure-preparedness"
          aria-label={t('questions.question-3.option-3')}
          className="my-4 font-display text-base font-bold normal-case"
          selected={values['financialPreparedness'] === 'unsure-preparedness'}
        >
          {t('questions.question-3.option-3')}
        </ToggleButton>
        <ToggleButton
          value="prepared"
          aria-label={t('questions.question-3.option-4')}
          className="my-4 font-display text-base font-bold normal-case"
          selected={values['financialPreparedness'] === 'prepared'}
        >
          {t('questions.question-3.option-4')}
        </ToggleButton>
        <ToggleButton
          value="very-prepared"
          aria-label={t('questions.question-3.option-5')}
          className="my-4 font-display text-base font-bold normal-case"
          selected={values['financialPreparedness'] === 'very-prepared'}
        >
          {t('questions.question-3.option-5')}
        </ToggleButton>
      </ToggleButtonGroup>
    </div>
  )
