...
const Home: FC = () => {
  ...
  return (
    <Layout>
                ...
                <TabPanel className="px-1 py-4" key={title} value={title}>
                  <div className="flex flex-col gap-6 rounded md:flex-row">
                    <Paper className="p-8 md:w-2/5 md:grow">
                      <h2 className="h2 mb-8 flex items-center text-primary-700">
                        {heading}
                      </h2>
      ...
      <h2 className="h2 mt-10 mb-8">{t('supporting-seniors.title')}</h2>
      ...
      <h2 className="h2 mt-10 mb-8">{t('contact-us.title')}</h2>
